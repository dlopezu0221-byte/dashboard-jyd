...
def main():
    ...
    cutoff_str  = '14/08/2026'  # Corte explícito
    ...
    last_day_ago = min(last_day_ago, 14)  # Corte explícito: 14 de agosto

    print(f'\n📅 JULIO: último día={last_day_jul} | AGOSTO: último día={last_day_ago} (corte=14)')
